...
FF350FCUEfisProfile::FF350FCUEfisProfile(ProductFCUEfis *product) : FCUEfisAircraftProfile(product) {
    ...
    XPLMDebugString("===== FF350 PROFILE CONSTRUCTOR CALLED =====\n");
...
// ÉLIGIBILITÉ DU PROFIL VIS-À-VIS DE L'AVION CHARGÉ =============================================================
bool FF350FCUEfisProfile::IsEligible() {
    return Dataref::getInstance()->exists("AirbusFBW/FCUAvail");
}


// LISTAGE DATAREFS SURVEILLÉES POUR MÀJ AFFICHEURS ==============================================================
